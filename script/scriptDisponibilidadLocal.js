...
//Disponibilidad en local.php
document.addEventListener('DOMContentLoaded', function () {
    const fechaInput = document.getElementById('fechaLocalMovil');
    const estadoDisponibilidad = document.getElementById('estadoDisponibilidadMovil');
    const btnGuardar = document.getElementById('guardarDisponibilidadMovil');
    const idLocal = fechaInput.getAttribute('data-id-local-movil');
